...
public class ExportPDFTests {
	...
	@BeforeAll()
		void BeforeSetUp() {
			...
			arrList = new ArrayList<TransactionObject>(); // This needs to be a transaction input eventually.
	...
	public void createTestTwo() {
		assertDoesNotThrow(() -> pdfService.createPDF(arrList, month, year, profileID, accountBalance), "An exception has occured.");
	}
...
//			
//			//Image Initialization
//			Image logo = new Image(ImageDataFactory.create("src/test/java/com/revature/thevault/exportpdf/vault_logo.png"));
//
//			// Border Creation
//			
...
//			
//			Style tableCellStyle2 = new Style();
//			tableCellStyle2.setBackgroundColor(lightGray);
//			tableCellStyle2.setBorder(new SolidBorder(lightGray, 1F));
//			tableCellStyle2.setFixedPosition(320F, 750F, 0F);
//			
//			//Table Creation
//			// Table accountTable
//			Table accountTable = new Table(new float[]{3F, 2F}, true);
//			accountTable.setWidth(UnitValue.createPercentValue(100));
//			accountTable.addStyle(tableCellStyle2);
//			
...
//			statementPeriod.add(new Paragraph("1999-12-25 to 2020-03-05"));
//			
//			Cell accountNumber = new Cell();
//			accountNumber.add(new Paragraph("1234567890"));
//			
...
//			
//			// Table table
//			Table table = new Table(new float[]{1F, 0.5F, 1F, 1F, 2F}, false); // In this float example, the float numbers represent table size.
